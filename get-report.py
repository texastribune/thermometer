...
# set array_index to 0 for Giving Tuesday report, 2 for EOY report and 3 for SMD/FMD report
array_index = 2
path = "/services/data/v46.0/analytics/reports/00OPe00000RMaJrMAL"
filename = "bts2025.json"
